...
const db = require("./src/db"); // Configuration de la base de données
const routes = require("./src/routes"); // Gestion des routes de l'API
const seedDatabase = require("./src/seed"); // Importer la fonction de seed
